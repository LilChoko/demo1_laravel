        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="contact-form">
                    ...
                    <!-- Ajustes en formulario de contacto -->
                    <form action="{{ route('contact.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <input type="text" name="fullname" class="form-control" placeholder="Your Name" value="{{ old('fullname') }}" />
                            </div>
                            <div class="col-md-6">
                        ...
                        <!-- Despliegue de mensajes de éxito -->
